...
public class IndexController extends AppBaseController {
    ...
    public ResponseEntity login(HttpServletRequest httpServletRequest, HttpServletResponse httpServletResponse,String userName, String password){
        ...
        return new ResponseEntity(ok("登录失败",null), HttpStatus.OK);
    }
